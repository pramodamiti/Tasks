...
if (rightBtn) {
    rightBtn.addEventListener("click", () => {
        ...
        if (trendsContainer) {
            trendsContainer.innerHTML = (_a = trendSlides[currentIndex]) !== null && _a !== void 0 ? _a : "";
        }
    });
}
(_a = document.querySelector(".trend-btn.left")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", () => {
    var _a;
